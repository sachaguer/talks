...
author: "Sacha Guerrini, UCL seminar, 9th October 2025"
date-meta: "October 9, 2025"
image: images/unions.jpg
description: |
  Informal talk at University College London during a visit in London.
format:
   revealjs: 
    theme: default
...
<div style="
  ...
  top: 0px;
">
<img src="images/leiden.jpg" alt="Leiden" width="200px">
...
\begin{tikzpicture}[scale=1, font=\small, node distance={40mm}, thick, main/.style = {draw, rectangle, minimum size=7mm, text centered}, label/.style = {align=center, text width=30mm}]
   ...
   \node[label, anchor=north] at (observation.south) {oSimulated observation};
...
## Pure B-mode correlation functions{visibility="uncounted" style="font-size:24px"}
...
## B-modes with COSEBIS{visibility="uncounted" style="font-size:30px"}
