...
<p float="left">
  <img src="images/contours_s8_omegam_blind_update.png" width="45%" />
  <img src="images/contours_s8_omegam_cell_blind_update.png" width="45%" />
</p>
...
## Shear $m$-bias{visibility="uncounted"}
...
## Redshift distribution uncertainty{visibility="uncounted"}
...
## PSF systematics (harmonic space){visibility="uncounted"}

::: {.footer}
Sacha Guerrini | *Euclid* France 2025
:::

![](images/leakage_bias_fraction_ee.png)

## Scale cuts (harmonic space){visibility="uncounted"}

::: {.footer}
Sacha Guerrini | *Euclid* France 2025
:::

![](images/Cl_integrand_vs_k.png)

## Data vector (harmonic space){visibility="uncounted"}

::: {.footer}
Sacha Guerrini | *Euclid* France 2025
:::

![](images/data_vectors_cell.png)

## Covariance validation (harmonic space){visibility="uncounted"}

::: {.footer}
Sacha Guerrini | *Euclid* France 2025
:::

![](images/relative_errorbar_comparison_non_gaussian_update.png)